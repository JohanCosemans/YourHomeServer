...
public class CachedMPD extends MPD {
	 ...
	 *
	 * @param artist
	 *            The Artist object to extract the artist name from.
	 ...
	 *
	 * @param albums
	 *            List of Album objects to add path information.
	 * @throws IOException
	 *             Thrown upon a communication error with the server.
	 * @throws MPDException
	 *             Thrown if an error occurs as a result of command execution.
	 */
	@Override
	 ...
	 *
	 * @param albums
	 *            The albums to add detail information to.
	 * @param findYear
	 *            Not applicable to this class extension.
	 * @throws IOException
	 *             Thrown upon a communication error with the server.
	 * @throws MPDException
	 *             Thrown if an error occurs as a result of command execution.
	 ...
	 * Get all albums.
	 *
	 * @param trackCountNeeded
	 *            Do we need the track count ?
	...
	public List<Album> getAllAlbums(final boolean trackCountNeeded) throws IOException, MPDException {
		...
		if (this.isCached()) {
			...
			for (final List<String> ai : albumListSet) {
				...
				if (thirdList != null && thirdList.isEmpty()) { // no album
																// artist
	 ...
	 *
	 * @param albums
	 *            List of Album objects to get Album Artists from.
	 ...
	 *
	 * @param albums
	 *            List of Album objects to get Artists or Album Artists from.
	 * @param useAlbumArtist
